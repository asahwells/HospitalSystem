...
class Bloodbaglist extends Component {
	...
	async onFetchData(limit) {
		...
		await db
			...
			.then((snapshot) => {
				...
				this.setState({
					bloodbaglist: snapshot.data() ? snapshot.data() : {},
	...
	handleFormDailogToUpdate = async (event) => {
		...
		const res = await Service.updateData("bloodbags", "bloodbags", sendData);
						...
						<tbody className="tablebody">
							<tr>
								...
								<td className="qty align-middle">
									{this.state.bloodbaglist && this.state.bloodbaglist.Apositive
							...
							<tr>
								<td className="bloodgroup align-middle">A-</td>
								<td className="qty align-middle">
									{this.state.bloodbaglist && this.state.bloodbaglist.Anegative
							...
							<tr>
								...
								<td className="qty align-middle">
									{this.state.bloodbaglist && this.state.bloodbaglist.ABpositive
							...
							<tr>
								<td className="bloodgroup align-middle">AB-</td>
								<td className="qty align-middle">
									{this.state.bloodbaglist && this.state.bloodbaglist.ABnegative
							...
							<tr>
								...
								<td className="qty align-middle">
									{this.state.bloodbaglist && this.state.bloodbaglist.Bpositive
							...
							<tr>
								<td className="bloodgroup align-middle">B-</td>
								<td className="qty align-middle">
									{this.state.bloodbaglist && this.state.bloodbaglist.Bnegative
							...
							<tr>
								...
								<td className="qty align-middle">
									{this.state.bloodbaglist && this.state.bloodbaglist.Opositive
							...
							<tr>
								<td className="bloodgroup align-middle">O-</td>
								<td className="qty align-middle">
									{this.state.bloodbaglist && this.state.bloodbaglist.Onegative
