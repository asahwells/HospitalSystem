...
console.log(State.getAllStates().map((namex) =>
namex))
Country.getAllCountries().map((namex) =>
namex.name)
          ...
          <div className="row">
            ...
            <div className="col-md-12 mb-3">
              ...
              <input
                ...
                className="form-control"
                      id="Nextofkin"
                      value={this.props.personDetails.Nextofkin}
                onChange={this.props.onEdit}
              />
            </div>
                  </div>
                  <div className="form-row">
            <div className="col-md-12 mb-3">
              <label htmlFor="validationDefault04">Next of kin email</label>
              <input
                type="text"
                name="Nextofkinemail"
                className="form-control"
                      id="Nextofkinemail"
                      value={this.props.personDetails.Nextofkinemail}
                onChange={this.props.onEdit}
              />
            </div>
                </div>
                <div className="form-row">
            <div className="col-md-12 mb-3">
              <label htmlFor="validationDefault04">Next of kin address</label>
              <input
                type="text"
                name="Nextofkinaddress"
                className="form-control"
                      id="Nextofkinaddress"
                      value={this.props.personDetails.Nextofkinaddress}
                onChange={this.props.onEdit}
              />
            </div>
          </div>
